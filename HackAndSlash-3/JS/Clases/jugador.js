...
export default class Jugador {
  ...
  constructor(anchoJuego, altojuego) {
    ...
    this.y = 100;  // Posición Y inicial (sobre suelo)
    ...
    this.cuerpo = Matter.Bodies.rectangle(
      ...
      this.altoSprite,                // Alto del cuerpo
      {
        ...
        friction: 0.0,             // deslizamiento lateral
  ...
  update(input, dt) {
    ...
    this.x = this.cuerpo.position.x - this.anchoSprite / 2; // Centrado en X
   ...
   */
  enSuelo() {
    return this.y >= this.altojuego - this.altoSprite;
  }
}
